...
extern NSString * const IMFPushEnvironmentSandbox;
extern NSString * const IMFPushEnvironmentProduction;
...
/*!
 * This property is used to set the current working environment.  Valid values are IMFPushEnvironmentSandbox or IMFPushEnvironmentProduction.
 *
 */
