 ...
 * @param completionHandler - returns a IMFResponse or NSError
 */
-(void) registerDeviceToken: (NSData*) deviceToken completionHandler: (void(^) (IMFResponse *response, NSError* error)) completionHandler __attribute__ ((deprecated("This method was deprecated , please use registerWithDeviceToken:  or ")));
